    ...
    render(){
        return(
            <nav id={style.navigate}>
                ...
                <div className={style.menu2} onClick={()=>this.props.menubarContainer.onSelectMenu('Existing reservations')} onMouseOver={()=>this.props.menubarContainer.onReserveOver()} onMouseOut={()=>this.props.menubarContainer.onReserveOut()}><img width='24' height='24' src='img/exist_reservation.png' /><span className={style.text}>{this.props.menubarContainer.state.reservation}</span></div>
